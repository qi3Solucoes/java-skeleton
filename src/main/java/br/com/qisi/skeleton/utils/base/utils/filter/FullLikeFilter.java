...
public class FullLikeFilter<T> implements BaseQueryFilter<T> {
  private static final String FULL_LIKE = "%";
  ...
  public FullLikeFilter(Predicate predicate, CriteriaBuilder criteriaBuilder, Root<T> root, List<QueryParam> queryParams, BaseQueryFilter<T> nextFilter) {
  ...
  public Predicate agregatePredicate() {
    ...
    for (QueryParam queryParam : queryParams) {
      ...
      if (FULL_LIKE.equalsIgnoreCase(queryParam.getOperation())) {
