...
public class RightLikeFilter<T> implements BaseQueryFilter<T> {
  private static final String RIGHT_LIKE_OPERATOR = "%>";
  ...
  public RightLikeFilter(Predicate predicate, CriteriaBuilder criteriaBuilder, Root<T> root, List<QueryParam> queryParams, BaseQueryFilter<T> nextFilter) {
  ...
  public Predicate agregatePredicate() {
    ...
    for (QueryParam queryParam : queryParams) {
      ...
      if (RIGHT_LIKE_OPERATOR.equalsIgnoreCase(queryParam.getOperation())) {
