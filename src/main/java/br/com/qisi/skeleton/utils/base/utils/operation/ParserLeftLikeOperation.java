...
public class ParserLeftLikeOperation implements BaseQueryParser {
  private static final String LEFT_LIKE_OPERATION = "%<";
  private final String query;
  private final BaseQueryParser nextParser;

  public ParserLeftLikeOperation(String query, BaseQueryParser nextParser) {
    this.query = query;
  ...
  public List<QueryParam> parseQuery(List<QueryParam> queryParams) {
    ...
    queryParams = decorateList(queryParams, LEFT_LIKE_OPERATION, LEFT_LIKE_OPERATION, this.query);
